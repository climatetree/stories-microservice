...
, and then sort the result by the extent of matching.
 */

findStoryByKeyword=(keyword,limit,page)=>storyModel.find({$text:{$search:keyword}}).skip((page-1)*limit).limit(limit);
