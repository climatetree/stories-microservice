...
module.exports = app => {
    ...
    app.get('/v1/stories/all/strategy', findAllStrategy);
    app.get('/v1/stories/all/solution', findAllSolution);
    app.get('/v1/stories/all/sector', findAllSector);
    app.get('/v1/stories/all/strategy/:strategy', findStrategyByName);
    app.get('/v1/stories/all/solution/:solution', findSolutionByName);
    app.get('/v1/stories/all/sector/:sector', findSectorByName);
